...
type TodoParams = {
  ...
  dialogOpen: boolean
  onCreateTodo: () => void
  onChangeTodo: (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => void
  onToggleDialog: () => void
}

export const TodoAddFormDialog = (todoParams: TodoParams) => (
  <Dialog fullWidth open={todoParams.dialogOpen} onClose={todoParams.onToggleDialog}>
    <form
      onSubmit={(e) => {
        e.preventDefault()
