...
export class PasswordChangeParams extends BaseEntity<PasswordChangeParams> {
  ...
  static create(current_password: Password, password: Password, password_confirmation: Password) {
    return new PasswordChangeParams(current_password, password, password_confirmation)
  }
