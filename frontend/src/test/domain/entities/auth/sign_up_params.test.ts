...
describe('SignUpParams', () => {
  ...
  describe('正常系', () => {
    it('インスタンス生成できる', () => {
      ...
      const entity = SignUpParams.create(userName, email, password, passwordConfirmation)
  ...
  describe('異常系', () => {
    it('パスワード不一致でエラー', () => {
      ...
      expect(() => SignUpParams.create(userName, email, password, passwordConfirmation)).toThrow(
        '新パスワードと確認用パスワードの値が異なります',
      )
    })
  })
})
